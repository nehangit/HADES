...
from agents.tools_registry import ALL_TOOLS, sqlmap_tool
import os
...
class SQLiExpertAgent:
    def __init__(self, model="gpt-4o"):
        ...
        self.agent = initialize_agent(
            tools=ALL_TOOLS.append(sqlmap_tool),
            llm=self.llm,
    ...
    def run(self, target, instruction):
        prompt = (
            "You are a web exploitation expert specializing in SQL injection.\n"
